...
function uix_contact_options_page(){
    ...
    {
      wp_die( __('You do not have sufficient permissions to access this page.', 'uix-contact') );
    }
...
<div class="wrap uix-bg-custom-wrapper">
	...
	$tabs[] = [
	    'tab'     =>  'temp', 
		'title'   =>  __( 'Template Files', 'uix-contact' )
	];
    ...
    <h2 class="nav-tab-wrapper">
        <?php foreach ( $tabs as $key ) :  ?>
            <?php $url = 'admin.php?page=' . rawurlencode( UixContact::HELPER ) . '&tab=' . rawurlencode( $key[ 'tab' ] ); ?>
